...
public:
  ...
  STDMETHOD(log4)(VARIANT aVal1, VARIANT aVal2, VARIANT aVal3, VARIANT aVal4);
  STDMETHOD(debug4)(VARIANT aVal1, VARIANT aVal2, VARIANT aVal3, VARIANT aVal4);
  STDMETHOD(info4)(VARIANT aVal1, VARIANT aVal2, VARIANT aVal3, VARIANT aVal4);
  STDMETHOD(warn4)(VARIANT aVal1, VARIANT aVal2, VARIANT aVal3, VARIANT aVal4);
